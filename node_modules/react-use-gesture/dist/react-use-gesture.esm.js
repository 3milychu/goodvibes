...
function () {
  ...
  _createClass(Recognizer, [{
    ...
    key: "handler",
    get: function get() {
      return this.controller.handlers[this.gestureKey];
    }
  }]);
...
function (_CoordinatesRecognize) {
  ...
  function DragRecognizer(controller, args) {
    ...
    _this.setListeners = function () {
      ...
      var dragListeners = supportsTouchEvents() ? [['touchmove', _this.onDragChange], ['touchend', _this.onDragEnd], ['touchcancel', _this.onDragEnd]] : [['mousemove', _this.onDragChange], ['mouseup', _this.onDragEnd]];
  ...
  _proto.addBindings = function addBindings() {
    if (this.controller.config.pointer) {
      ...
      if (supportsTouchEvents()) this.controller.addBindings('onTouchStart', this.onDragStart);else this.controller.addBindings('onMouseDown', this.onDragStart);
    }
  };
...
function (_CoordinatesRecognize) {
  ...
  function MoveRecognizer(controller, args) {
    ...
    _this.onPointerEnter = function (event) {
      if (!_this.controller.config.enabled || !_this.controller.config.hover.enabled) return;
...
export { addV, rubberbandIfOutOfBounds, subV, useDrag, useGesture, useMove, usePinch, useScroll, useWheel };
