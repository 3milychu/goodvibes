...
export declare type GestureState<T extends GestureKey> = State[StateKey<T>];
export declare type PartialGestureState<T extends GestureKey> = Partial<GestureState<T>>;
export declare type FullGestureState<T extends GestureKey> = SharedGestureState & State[StateKey<T>];
export declare type Handler<T extends GestureKey> = (state: FullGestureState<T>) => any | void;
...
export declare type RecognizerClass<T extends GestureKey> = {
...
export declare type NativeHandlersPartial = Partial<Omit<React.DOMAttributes<Element>, 'onDrag' | 'onScroll' | 'onWheel'>>;
