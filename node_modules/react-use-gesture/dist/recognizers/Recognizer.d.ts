...
import { StateKey, GestureKey, SharedGestureState, Fn, UseGestureEvent, IngKey, InternalConfig, Handler, GestureState, PartialGestureState, Vector2, FalseOrNumber, FullGestureState } from '../types';
/**
 * @private
...
export default abstract class Recognizer<T extends GestureKey> {
     ...
     */
    constructor(gestureKey: T, controller: Controller, args?: any[]);
     ...
     */
    protected getStartGestureState: (values: import("../types").Tuple<number>, event: import("react").MouseEvent<Element, MouseEvent> | import("react").TouchEvent<Element> | import("react").WheelEvent<Element> | import("react").PointerEvent<Element> | import("../types").WebKitGestureEvent) => import("../types").State[StateKey<T>] & {
        _active: boolean;
